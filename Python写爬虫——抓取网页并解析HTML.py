...
class Crawler(object):
		...
		def _getSoup(self,url):
				req=urllib2.Request(url=url,headers={'User-Agent':'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.4 (KHTML, like Gecko) Chrome/22.0.1229.94 Safari/537.4'})
		...
		def _getNextPage(sel,soup):
				nextUrl = 'http://sitedossier.com' + soup.ol.nextSibling.nextSibling.get('href')
